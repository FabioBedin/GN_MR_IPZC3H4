...
data_se_old <- make_se(data_unique_old, columns, expdesign_old)
```

### Protein counts {.tabset .tabset-fade}
...
```{r}
plot_numbers_lables(data_se_old)
```

### Venn plots {.tabset .tabset-fade}
...
common <- c("HDAC2", "RBM14", "ZC3H4", "ANXA1", "BST2", "CBS", "GEMIN4", "KPNA2", "PPP6C", "RPL23A", "RPS24", "SLC16A3")
```

#### Significant

common proteins are: `r common`
```{r summary2, out.width = "150%"}
knitr::include_graphics("assets/venn_old_new.png",  error = F)
```
