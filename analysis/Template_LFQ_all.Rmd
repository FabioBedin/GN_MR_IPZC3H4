...
params:
  proteinGroups:
    label: "Input dataset:"
    value: proteinGroups_all.txt
    input: file
  expdesign:
    label: "Experimental design:"
    value: expdesign_all.tsv
    input: file
  n_peptides: 
    label: "N° Peptides"
    value: 2
...
if(n_edge != 0){
  knitr::include_graphics("assets/network_FC_pvalue_all.png",  error = F)
}else{
  print("NOT enough data.")
}
```
...
if(enrich_map){
  knitr::include_graphics("assets/network_enrichmentmap_all.png",  error = F)
}else{
  print("NOT enough data.")
}
```
